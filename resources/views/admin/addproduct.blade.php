              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="{{ route('storeproduct') }}"method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        ...
                        name="product_name" placeholder="Input Here" />
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          ...
                          name="quantity" placeholder="1000" />
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea class="from-control" name="product_short_des" id="product_short_des" cols="30" rows="10"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <textarea class="from-control" name="product_long_des" id="product_long_des" cols="30" rows="10"></textarea>
                        </div>
                      </div>
                 ...
                 <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name">Upload Product Images</label>
                        <div class="col-sm-10">
