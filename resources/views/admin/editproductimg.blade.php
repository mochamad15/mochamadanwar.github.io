...
@section('page_title')
Edit Product Image - Supreme Footwear
@endsection
@section('content')
                ...
                <div class="card-body">
                  <form action="{{ route('updateproductimg') }}"method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                        <img src="{{ asset($productinfo->product_img) }}" style="height: 200px" alt="">
                      </div>
                    </div>
                    ...
                    <input type="hidden" value="{{ $productinfo->id }}" name="id">
                      ...
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-name">Upload New Images</label>
                        <div class="col-sm-10">
